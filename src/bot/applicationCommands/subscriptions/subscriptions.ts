...
export default class Ping extends ApplicationCommand {
  ...
  public override async run({
    ...
    if (
      ...
      const subscriptionGroup = await this.client.prisma.subscriptionGroup.findUnique({ where: { id: name } });
      ...
      return Promise.all([
        this.client.prisma.subscriptionGroup.delete({ where: { id: subscriptionGroup.id } }),
        this.client.api.interactions.reply(interaction.id, interaction.token, {
          embeds: [
            {
      ...
      return Promise.all([
        this.client.prisma.subscribedUser.delete({ where: { id: userSubscription.id } }),
        this.client.api.interactions.reply(interaction.id, interaction.token, {
          embeds: [
            {
